#!/usr/bin/env python3
"""
Simple icon processor for Simple Editor
...
def create_iconset(source_png: str = "simpleeditor.png", output_dir: str = "Simple Editor.iconset"):
    """
    Create a complete iconset for macOS using the source PNG file
    ...
    for size, filename in sizes:
        try:
            ...
            icon_img = Image.new('RGBA', (size, size), (0, 0, 0, 0))  # Transparent background
            ...
            scale_factor = min(size / source_img.width, size / source_img.height)
...
def main():
    ...
    print("Creating app icon for Simple Editor using simpleeditor.png...")
